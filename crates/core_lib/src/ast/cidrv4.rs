...
impl RuleTrait for Cidrv4Rules {
    fn new() -> Self {
        Self {
            min_length: None,
            max_length: None,
    ...
    fn set_rule(&mut self, key: &str, value: Value, error: Option<String>) -> Result<(), String> {
        ...
        match key {
            ...
            _ => return Err(format!("Unknown cidrv4 rule: {}", key)),
        }
        Ok(())
    }
...
impl Mergeable for Cidrv4Rules {
    fn merge(&mut self, other: Cidrv4Rules) -> Result<(), String> {
...
impl Mergeable for Cidrv4Transform {
...
impl TransformTrait for Cidrv4Transform {
    fn new() -> Self {
        Cidrv4Transform {
            trim: None,
            to_lowercase: None,
