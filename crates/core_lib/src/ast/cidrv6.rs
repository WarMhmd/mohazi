...
impl RuleTrait for Cidrv6Rules {
    fn new() -> Self {
        Self {
            min_length: None,
            max_length: None,
    ...
    fn set_rule(&mut self, key: &str, value: Value, error: Option<String>) -> Result<(), String> {
        ...
        match key {
            ...
            _ => return Err(format!("Unknown cidrv6 rule: {}", key)),
        }
        Ok(())
    }
...
impl Mergeable for Cidrv6Rules {
    fn merge(&mut self, other: Cidrv6Rules) -> Result<(), String> {
...
impl Mergeable for Cidrv6Transform {
...
impl TransformTrait for Cidrv6Transform {
    fn new() -> Self {
        Cidrv6Transform {
            trim: None,
            to_lowercase: None,
